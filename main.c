...
int main()
{
    ...
    for(int i=0;i<4;i++) //////////////////////////////////////////////////////CAMBIARRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR
        for(int j=0;j<4;j++)
    ...
    printf("-------------------------------------------------------------------------\n");
    if(esCompacto(prob5,ESCENARIO_1,5)==1)
        printf("El codigo del escenario 1 cumple la condicion de ser compacto\n");
    else
        printf("El codigo del escenario 1 no cumple la condicion de ser compacto\n");
    if(esCompacto(prob7,ESCENARIO_2,7)==1)
        printf("El codigo del escenario 2 cumple la condicion de ser compacto\n");
    else
        printf("El codigo del escenario 2 no cumple la condicion de ser compacto\n");
    if(esCompacto(prob9,ESCENARIO_3,9)==1)
        printf("El codigo del escenario 3 cumple la condicion de ser compacto\n");
    else
        printf("El codigo del escenario 3 no cumple la condicion de ser compacto\n");
...
int esCompacto(float prob[],int n, int longitud)
{
    float longit = (float) longitud;
    float aux;
    int rta = 1, i=0;
    while(rta == 1 && i < n)
    {
        if(prob[i] != 0)
            aux = -1 * log2(prob[i]) - longit;
        else
        {
            aux = 0;
            rta = 0;
